...
### Current state of art in practice {-}
There are several companies offering Transportation Management System (TMS) Software Packages, which provide wide range of services depending on the market segment they focus on. For example, [3Gtms](https://www.3gtms.com/), [Cloud Logistics](https://www.gocloudlogistics.com/) or [Kuebix](https://www.kuebix.com/) are companies located in the USA that are mainly focused on small and medium companies and third party logistics. Due to their size they do not yet offer services for international rail, air or maritime transport. On the other hand, [JDA](https://jda.com/) is the largest independent provider of supply chain management software that offers solutions for global supply chain. Further, a UK-based [BluJay](https://www.blujaysolutions.com/) offers TMS and TM services to mid- and large-size shippers on a national and international level. Further, Canadian [Descartes](https://www.descartes.com/) offers TMS services for all freight modes, nationally and internationally. Moreover, [Oracle](https://www.oracle.com) offers a management platform for large shippers and third party logistics, while German [SAP](https://www.sap.com) developed a platform for supply chain management and integrated Enterprise Research Planning (ERP) that meets the requirements of global supply chain (LaGore, 2020).
...
- King, A. (2018). Defining “Multimodal TMS”. Available at: https://www.3gtms.com/resources/blog/defining-multimodal-tms [Accessed: 11/08/2021]
- LaGore, R. (2020) 2021 Best Transportation Management System (TMS) Software Packages. Available at: https://blog.intekfreight-logistics.com/best-transportation-management-software-tms [Accessed: 11/08/2021]
