...
### References {-}
-	European Commission (no date) Transport emissions | Climate Action. Available at: https://ec.europa.eu/clima/policies/transport_en (Accessed: 11 March 2021).
...
## Parcel load pooling {#parcel_pooling}
...
-	Truck Parking Europe (no date) Audit reports on secure truck parking locations - Truck Parking Europe. Available at: https://www.truckparkingeurope.com/2020/03/11/audit-reports-on-secure-truck-parking-locations/ (Accessed: 3 March 2021).
...
### References {-}
- Aiura, N. & Taniguchi, E. (2005) ‘PLANNING ON-STREET LOADING-UNLOADING SPACES CONSIDERING THE BEHAVIOUR OF PICKUP-DELIVERY VEHICLES’, Journal of the Eastern Asia Society for Transportation Studies, 6, pp. 2963–2974. doi: 10.11175/easts.6.2963.
- Alho, A. R. et al. (2018) ‘Improving mobility by optimizing the number, location and usage of loading/unloading bays for urban freight vehicles’, Transportation Research Part D: Transport and Environment. Elsevier Ltd, 61, pp. 3–18. doi: 10.1016/j.trd.2017.05.014.
- Brown, C. (2020) Should Delivery Fleets Pay to Park in Loading Zones? - Smart Cities - Fleet Forward. Available at: https://www.fleetforward.com/10127896/should-delivery-fleets-pay-to-park-in-loading-zones (Accessed: 21 March 2021).
- Dezi, G., Dondi, G. & Sangiorgi, C. (2010) ‘Urban freight transport in Bologna: Planning commercial vehicle loading/unloading zones’, Procedia - Social and Behavioral Sciences, 2(3), pp. 5990–6001. doi: 10.1016/j.sbspro.2010.04.013.
Letnik, T. et al. (2018) ‘Dynamic management of loading bays for energy efficient urban freight deliveries’, Energy, 159, pp. 916–928. doi: 10.1016/j.energy.2018.06.125.
- McLeod, F. & Cherrett, T. (2011) ‘Loading bay booking and control for urban freight’, International Journal of Logistics Research and Applications. Taylor & Francis, 14(6), pp. 385–397. doi: 10.1080/13675567.2011.641525.
- Mor, A., Speranza, M. G. & Viegas, J. M. (2020) ‘Efficient loading and unloading operations via a booking system’, Transportation Research Part E: Logistics and Transportation Review. Elsevier Ltd, 141, p. 102040. doi: 10.1016/j.tre.2020.102040.
- Muñuzuri, J. et al. (2017) ‘Improving the design of urban loading zone systems’, Journal of Transport Geography. Elsevier Ltd, 59, pp. 1–13. doi: 10.1016/j.jtrangeo.2017.01.004.
- Nourinejad, M. et al. (2014) ‘Truck parking in urban areas: Application of choice modelling within traffic microsimulation’, Transportation Research Part A: Policy and Practice. Elsevier Ltd, 64, pp. 54–64. doi: 10.1016/j.tra.2014.03.006.
- Patier, D. et al. (2014) ‘A New Concept for Urban Logistics Delivery Area Booking’, Procedia - Social and Behavioral Sciences. Elsevier B.V., 125, pp. 99–110. doi: 10.1016/j.sbspro.2014.01.1459.
- Pinto, R., Lagorio, A. & Golini, R. (2019) ‘The location and sizing of urban freight loading/unloading lay-by areas’, International Journal of Production Research. Taylor & Francis, 57(1), pp. 83–99. doi: 10.1080/00207543.2018.1461269.
- Smart Parking Systems® (no date) The economic benefits of Smart Parking Systems® > Smart Parking Systems - Intercomp Innovation. Available at: https://smartparkingsystems.com/en/the-economic-benefits-of-smart-parking-systems/ (Accessed: 21 March 2021).
- Stocker, G. (2012) Snizek+Partner Verkehrsplanungs GmbH - iLadezone - Intelligentes Ladezonenrouting und Management. Available at: https://www.snizek.at/go/de/projects/simulationen/94-iladezonen-intelligentes-ladezonenrouting-und-management (Accessed: 21 March 2021).
- VCÖ (2016) Urban Loading - VCÖ Vorbildhafte Mobilitätsprojekte. Available at: https://mobilitaetsprojekte.vcoe.at/urban-loading (Accessed: 21 March 2021).
...
## Commercial vehicle on-board safety systems {#comm_veh_safety}
...
- Berman, J. (2020) Freight rail offering aims to boost GPS and telematics adoption across North American railcar fleet - Logistics Management. Available at: https://www.logisticsmgmt.com/article/freight_rail_offering_aims_to_boost_gps_and_telematics_adoption_across_nort (Accessed: 24 February 2021).
- European Commission (2021) Telematic applications | Mobility and Transport. Available at: https://ec.europa.eu/transport/modes/rail/interoperability/interoperability/telematic_applications_de (Accessed: 15 February 2021).
