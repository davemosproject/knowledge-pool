...
|Individual|Facilitated use of public transport|**+**| Environmental sustainability (*7,12,13,15*)|European Commission, 2021a|
...
2. Why Austria has not implemented the Transmodel? What is necessary for an implementation?
3. What effect has multimodal information & route planning on energy consumption? 
4. What key features are needed in multimodal trip planning apps to be accessible for disabled or elderly and how can they be implemented to be inclusive for these specific groups?
