...
The authors welcome any feedback, questions and contributions that the readers may have. For further inputs please contact the corresponding author Martyna Bogacz on the following email address: davemos.library@boku.ac.at. <br/>
...
2. [Physical road infrastructure](#infrastructure)
    ...
    - [Operational design domains](#ODD) **NEW**
...
4. [Traffic management](#traffic)
    ...
    - [Dynamic route guidance](#dynamic_route) **NEW**
    ...
    - [Passengers and goods fleet management](#p_g_fleet_management) **NEW**
...
7. [Multimodal integrated system](#multimodal)
    - [First-last mile solutions](#flms) **NEW**
    - [Transit fares](#dist_time_fares) **NEW**
...
10. [Freight and commercial transport](#freight)
    ...
    - [Smart delivery space booking](#space_book) **NEW**
