...
\begin{figure}
\includegraphics[width=0.9\linewidth]{image/TRL} \caption{Technology readiness scale}\label{fig:unnamed-chunk-2}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{image/SRL} \caption{Societal readiness scale}\label{fig:unnamed-chunk-3}
\end{figure}
