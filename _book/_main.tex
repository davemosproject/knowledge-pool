...
\begin{figure}
\includegraphics[width=0.8\linewidth]{image/TRL_cropped} \caption{Technology readiness scale}\label{fig:unnamed-chunk-2}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{image/SRL_cropped} \caption{Societal readiness scale}\label{fig:unnamed-chunk-3}
\end{figure}
