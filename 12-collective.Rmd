...
- **Affected**: Citizen
- **Responsible**: National Governments, City government, Private Companies, Insurers
...
Some manufacturers such as Boeing (LeBeau, 2016), Airbus (J. Hawkins, 2018) and Volocopter (Holt, 2018) have already conducted the first flight tests of their prototypes.<br/><br/>
...
|:------------:|:-----------:|:------------:|:------------:|:------------:|
|Individual|It is expected to be too costly for general use|**-**|Equality (*5,10*)|Pramer and Sommavilla, 2020|
|Individual|The flight price is expected to settle in the range of a very expensive taxi|          **-**|Environmental sustainability (*7,12-13,15*)|Pramer and Sommavilla, 2020|
...
|Systemic|Stationary areas for safety checks|          **~**|Innovation & Infrastructure (*9*)|Pramer and Sommavilla, 2020|')
```
