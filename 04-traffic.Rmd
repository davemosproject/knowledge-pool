...
3. What effect the implementation of congestion charge zone will have on the traffic in neighbouring areas (due to eg. re-routing)?
...
### Open questions {-}
1.	What are the potential solutions that can be jointly used by traditional and automated vehicles (eg. during transition period when both types of vehicles will still be present)?
