...
Furthermore, research presents different dynamic and demand aware fleet management frameworks. A recent study shows combined goods and passenger transportation that is capable of (Manchella et al., 2022):

-	Negotiating prices between passenger and driver during the decision-making process
-	Matching of goods and vehicles
-	Dynamically generating optimal routes
-	Dispatching idle vehicles by using deep reinforcement learning
-	Allowing for distributed inference and collectively optimising fleet objectives

Compared to other methods that do not consider combined load transportation this method shows 15% increase in fleet utilization and a 20% increase in average vehicle profits.
Adaptive Model-Free Deep Reinforced Learning (RL), that recognises and adapts to diurnal ride-sharing (car-pooling), is a promising approach to solve effectiveness in e.g. public taxis (Haliem et al., 2022).
...
The field tests showed that compared to other management systems, current system is between 40% and 80% more efficient.<br/>

The previous European projects were, among others, [CHINO](https://ec.europa.eu/research/participants/documents/downloadPublic?documentIds=080166e5a7b1dc79&appId=PPGMS) (2006-2009) that looked at the containers handling in intermodal nodes, [SAIL](https://cordis.europa.eu/project/id/251589/reporting) (2011-2014) which explored ICT tools for logistics and business operations in the port and dry port areas or [MIT](http://www.mitproject.eu/) (2004-2009) that was concerned with fully automated system for the distributed intermodal transport (Harris et al., 2006).<br/>

A technology company [Nec.com](https://www.nec.com/en/global/solutions/transportation/task/fms_pis.html) provides smart fleet management system for 1700 buses in Hong-Kong as well as bus fleets in Singapore and India showing that these system can be applied in dense and complex urban networks and offer smart solutions that improve the performance of public transport.<br/>

The future of fleet management is evolving as the technology improves. The sustainability metric but also advancement in the blockchain technology, mobility as a service, keyless vehicle access, sustainable vehicle solutions and autonomous vehicles are expected to gain interest in the future (Johnson, 2021).
...
- Haliem, M., Aggarwal, V., Bhargava, B. (2022). AdaPool: A Diurnal-Adaptive Fleet Management Framework Using Model-Free Deep Reinforcement Learning and Change Point Detection. IEEE Transaction on Intelligent Transport Systems, 23 (3), 2471-2481. 10.1109/TITS.2021.3109611
...
- Johnson, L. (2021). The complete guide to fleet management. Available at: https://www.geotab.com/blog/what-is-fleet-management/ [Accesed: 27/12/2022]
...
- Manchella, K., Haliem, M., Aggarwal, V., Bhargava, B. (2022). PassGoodPool: Joint Passengers and Goods Fleet Management With Reinforcement Learning Aided Pricing, Matching, and Route Planning. IEEE Transaction on Intelligent Transport Systems, 23 (4), 3866-3877. 10.1109/TITS.2021.3128877
...
### Current state of art in research {-}
Current research addresses the evaluation of UVAR implementations and identifies their positive and negative effects. For example, Lopez (2018) found that Urban Consolidation Centres (UCCs), Cargo Bikes (CBs) and Off-hour Deliveries (OHDs) are the three preferred types of solutions to assist in mitigating unwanted side-effects of UVARs on the logistic sector. Further, current research focuses on the sustainable urban planning in cites affected by mass tourism (García Hernández, 2019; Nolasco‐Cirugeda, 2020). Additionally, most recent area of research deals with geofencing that aims at creating digital zones defined on a map, with specific rules, that can be transmitted to the vehicles (Arnesen et al., 2020).<br/>

Ogunkunbi and Meszaros (2022) identified criteria for effective urban vehicle access regulations that help to select feasible and effective UVAR measures. Criteria can thereby help to identify main barriers and drivers for UVAR adoption as well as aid monitoring and evaluation upon implementation. Further research, regarding social acceptability and equity, was conducted by Versigghel et al. (2022) underlining the importance of stakeholder involvement throughout different stages of implementation for a successful and equitable outcome of the scheme.
...
The report of the EIT Urban Mobility (EIT, 2022) offers a practitioner-oriented overview of the recent evolution of UAVRs across Europe. The recommendations were developed during customized workshops while involving more than 20 experts from public and private sectors. It covers diverse schemes and showcases best practices involving aspects related to regulation, planning, design, enforcement as well as stakeholder and citizen involvement.
...
- EIT (2022). Urban Vehicle Access Regulations: From Design to Implementation. EIT Urban Mobility. Available at: https://www.eiturbanmobility.eu/wp-content/uploads/2022/10/EIT-UrbanMobilityNext6_HD2.pdf [Accessed: 30/12/2022]
...
- Ogunkunbi, G. A., Meszaros, F. (2022). Identifying criteria for effective urban vehicle access regulations adoption. Environmental Science Europe, 34, 103. https://doi.org/10.1186/s12302-022-00682-4
...
- Versigghel, J., Fransen, K., Gautama, S. (2022). Participation, acceptability and equity aspects of urban vehicle access regulations: Who benefits and who needs to adapt?. Transportation Research Procedia. Universiteit Gent. Available at: hdl.handle.net/1854/LU-8761228 (Accessed: 2. January 2023)
