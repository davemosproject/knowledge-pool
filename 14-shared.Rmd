...
cat('| Impact level| Indicator|Impact direction| Goal description and number|Source|
|:------------:|:-----------:|:------------:|:------------:|:------------:|
|Individual|E-scooter trips replace mainly walking trips|**-**|Health & Wellbeing (*3*)|Laa and Leth, 2020|
...
|Individual|Increase in participants on existing road infrastructure|**~**|Innovation & Infrastructure (*9*)|Laa and Leth, 2020|
|Systemic|Highest user share among young males|**-**|Equality (*5,10*)|Laa and Leth, 2020|
|Systemic|E-scooter trips repalce more sustainable transport modes|**-**|Environmental sustainability (*7,12-13,15*)|Laa and Leth, 2020|
