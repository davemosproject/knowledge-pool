...
|:------------:|:-----------:|:------------:|:------------:|:------------:|
|Individual|Increases driving safety and comfort|**+**|Health & Wellbeing (*3*)||
|Individual||**-**|Sustainable economic development (*8,11*)||
|Systemic||          **+**|Innovation & Infrastructure  (*9*)||')
```
...
- Samsara.com (2020). Advanced Driver Assistance Systems (ADAS) for Commercial Fleets. Available at:< https://www.samsara.com/guides/adas> Accessed: 28/04/2021 - Shuttleworth, J. (2019). SAE Standards News: J3016 automated-driving graphic update
Available at: <https://www.sae.org/news/2019/01/sae-updates-j3016-automated-driving-graphic> Accessed: 28/04/2021
